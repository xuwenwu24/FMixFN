...
REAL::A,HERITABILITY,MEAN,SD2,XX,T,&
	  ...
	  V1,V2,V3,V4,VG,VE,&    ! V1 is the larger variance and V2 is the smaller
...
READ(15,*)PI        ! the ratio that SNP with larger variances
...
CALL MixP(NUMBER,RANDOM,N_FIX,Y,T_MATRIX,PI,VG,VE,G,UUU)	 ! Calculate the Iteration Conditional Expectation algorithm
...
SUBROUTINE MixP(N,SNP,N_FIX,PHENO,DESIGN,P,VG,VE,G,U)
IMPLICIT NONE
...
REAL::G(SNP),&			    ! the vector of SNP effects
		...
		VG,&                ! total additive genetic variance
                HERITABILITY,&      !
		V1,V2,V3,V4,&             ! the variances of large and small SNP effects (V1 is larger)
